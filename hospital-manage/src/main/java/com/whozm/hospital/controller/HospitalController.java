package com.whozm.hospital.controller;

import com.whozm.hospital.service.ApiService;
import com.whozm.hospital.service.HospitalService;
import com.whozm.hospital.util.*;
...
public class HospitalController {
	...
	public Result AgreeAccountLendProject(HttpServletRequest request, HttpServletResponse response) {
		try {
			Map<String, Object> paramMap = com.whozm.hospital.util.HttpRequestHelper.switchMap(request.getParameterMap());
...
//			}
			...
			return com.whozm.hospital.util.Result.ok(resultMap);
		} catch (com.whozm.hospital.util.YyghException e) {
			return com.whozm.hospital.util.Result.fail().message(e.getMessage());
		}
	}
...
//			}
			...
			return com.whozm.hospital.util.Result.ok();
		} catch (com.whozm.hospital.util.YyghException e) {
			return com.whozm.hospital.util.Result.fail().message(e.getMessage());
		}
	}
